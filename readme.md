in this project, we are using openai's vision api to analyze the contract and template pdfs and apply matching strikethrough formatting to the contract document.
